 ...
 *
 * @link              http://www.myweb.com
 * @since             1.0.0
 * @package           Wp_Book
 *
 * @wordpress-plugin
 * Plugin Name:       WP BOOK
 * Plugin URI:        http://www.wp-book.com
 * Description:       This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version:           1.0.0
 * Author:            Shibil PM
 * Author URI:        http://www.myweb.com
 * License:           GPL-2.0+
...
//Adding Custom post type, custom hierarchical Taxanomy And Custom Non-hierarchical taxonomy
require_once( 'public/bk-create-cpt.php' );

//Adding Metabox and Meta table
require_once( 'public/bk-meta.php' );

//Adding submenu page
require_once( 'admin/bk-settings.php' );

//Adding shortcode
require_once( 'public/bk-shortcode.php' );

require_once( 'public/bk-widget.php' );
